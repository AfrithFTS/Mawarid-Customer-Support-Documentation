...
> 1. <a href="#1-mails">Mails</a>
> 2. <a href="#2-tickets">Tickets</a>
...
* In this menu, it shows all the tickets which has been created by all the users in the customer support.

* It also shows all tickets which has been in any status.
