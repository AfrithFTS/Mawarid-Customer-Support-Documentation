...
>   * <a href="#unassigned-tickets">Unassigned Tickets</a>
...
* My Tickets menu shows the coordinator's customer tickets by the status separation.

* In this menu, the tickets are listed in the ist view and the list of tickets are categorized by the status in workflow bar.

* The ticket status of workflow bars are; 
...
* This Unassigned Tickets menu shows the tickets, which is not assigned to any users.

* These unassigned tickets are the coordinator's customers tickets which is not assigned to anybody.

* This menu is very usefull for the coordinators to see the unassigned tickets separately, he no need to find the unassigned tickets to take actions.
